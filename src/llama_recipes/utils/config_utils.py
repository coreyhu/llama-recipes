...
from llama_recipes.configs import datasets, LlamaLoraConfig, LlamaAdapterConfig, PrefixConfig, TrainConfig
...
def generate_peft_config(train_config: TrainConfig, kwargs: dict):
    configs = (LlamaLoraConfig, LlamaAdapterConfig, PrefixConfig)
...
def get_dataloader_kwargs(train_config: TrainConfig, dataset, tokenizer, mode):
        kwargs = {}
